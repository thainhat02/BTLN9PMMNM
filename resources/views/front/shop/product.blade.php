...
{{--                                            RowId of the item in the Cart--}}
                                        ...
                                        @if($rowId)
                                            ...
                                            <button class="primary-btn pd-cart" onclick="updateCart('{{$rowId}}', document.getElementById('qtyInput').value)">Cập nhật giỏ</button>
                                        @else
                                            <!-- Hiển thị nút thêm vào giỏ hàng nếu rowId không tồn tại -->
                                            <a href="javascript:addToCart({{$product->id}}, true)" class="primary-btn pd-cart">Thêm giỏ hàng</a>
                                        @endif
                                    </div>
                                </div>
                                <ul class="pd-tags">
                                    <li><span>Thể loại: </span>{{$product->productCategory->name}}</li>
                                    <li><span>Tác giả: </span>{{$product->tag}}</li>
                                    <li><span>SKU: </span>{{$product->sku}}</li>
                                    <li class="pd-share"><span>Chia sẻ: </span>
                    ...
                    <div class="product-tab">
                        <div class="tab-item">
                            <ul class="nav" role="tablist">
                                <li><a class="active" href="#tab-1" data-toggle="tab" role="tab">Chi tiết</a></li>
                                <li><a href="#tab-3" data-toggle="tab" role="tab">Phản hồi khách hàng
