            ...
            <div class="profile-nav col-md-3">
                <div class="panel">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        <li><a class="tablinks active" onclick="openTab(event, 'profile')"> <i class="fa fa-user"></i>Thông tin cá nhân</a></li>
                        <li><a class="tablinks" onclick="openTab(event, 'orders')"> <i class="fa fa-calendar"></i> Đơn hàng <span class="label label-warning pull-right r-activity">{{count($orders)}}</span></a></li>
                        <li><a class="tablinks" onclick="openTab(event, 'address')"> <i class="fa fa-edit"></i> Địa chỉ</a></li>
                    </ul>
                </div>
            </div>
            <div id="profile" class="tabcontent profile-info col-md-9">
                <div class="panel">
                    <div class="bio-graph-heading">
                        ...
                        <textarea name="description" id="description" rows="1" placeholder="">{{$user->description}}</textarea>
                        <script>
                    ...
                    <div class="panel-body bio-graph-info">
                        ...
                        <div class="row">
                            <div class="bio-row">
                                <p><label for="firstname">Họ</label>: <input name="name" type="text" value="{{$user->name}}"></p>
                            </div>
                            <div class="bio-row">
                                <p><label for="lastname">Tên</label>: <input name="lastname" type="text" value="{{$user->lastname}}"></p>
                            </div>
                            <div class="bio-row">
                                <p><label>Tên công ty</label>: <input name="company_name" type="text" value="{{$user->company_name}}"></p>
                            </div>
                            ...
                            <div class="bio-row">
                                <p><label for="phone">Điện thoại</label>: <input name="phone" type="text" value="{{$user->phone}}"></p>
                            </div>
                            <div class="bio-row">
                                <p><label for="country">Quốc gia</label>: <input name="country" type="text" value="{{$user->country}}"></p>
                            </div>
                            <div class="bio-row" style="width: 100% !important;">
                                <p><label for="street_address">Đường </label>: <input style="width: 75% !important;" name="street_address" type="text" value="{{$user->street_address}}"></p>
                            </div>
                            <div class="bio-row">
                                <p><label for="town_city">Thành phố </label>: <input name="town_city" type="text" value="{{$user->town_city}}"></p>
                            </div>
                            <div class="bio-row">
                                <p><label for="postcode_zip"> Mã Zip </label>: <input name="postcode_zip" type="text" value="{{$user->postcode_zip}}"></p>
                            </div>
                            <div class="bio-row" style="width: 100% !important;">
                                <button type="button" class="save-profile-btn" onclick="saveProfileInfo()">Lưu</button>
