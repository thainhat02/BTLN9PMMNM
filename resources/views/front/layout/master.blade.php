        ...
        <div class="container">
            <div class="ht-left">
                <div class="mail-service">
                    ...
                    <a href="mailto:thainhatx4@gmail.com" style="color: black;">thainhatx4@gmail.com</a>
                </div>
                <div class="phone-service">
                    <i class="fa fa-phone"></i>
                    <a href="tel:0123456789" style="color: black;">+84 123456789</a>
                </div>
            </div>
            <div class="ht-right">
                ...
                <div class="lan-selector">
                    <select class="language_drop" name="countries" id="countries" style="width: 350px;">
                        ...
                        <option value="yt" data-title="English">English</option>
                    </select>
                </div>
                        ...
                        <li class="cart-icon">
                            ...
                            <div class="cart-hover">
                                ...
                                <div class="select-button">
                                    <a href="/cart" class="primary-btn view-cart">Giỏ hàng</a>
            ...
            <div class="nav-depart">
                <div class="depart-btn">
                    ...
                    <ul class="depart-hover">
                        <li class="active"><a href="127.0.0.1:8000/shop/category/Tâm linh luân hồi">Tâm linh luân hồi</a></li>
                        <li><a href="/shop/category/Ngôn tình">Ngôn tình</a></li>
                        <li><a href="/shop/category/Thiếu nhi">Thiếu nhi</a></li>
                        <li><a href="/shop/category/Văn học kinh điển">Văn học kinh điển</a></li>
                        <li><a href="/shop/category/Tiểu thuyết">Tiểu thuyết</a></li>
                        <li><a href="/shop/category/Truyện ngắn">Truyện ngắn</a></li>
                        <li><a href="/shop/category/Kiếm hiệp">Kiếm hiệp</a></li>
                        <li><a href="/shop/category/Huyền bí - Giả tưởng">Huyền bí - Giả tưởng</a></li>
                        <li><a href="/shop/category/Du ký">Du ký</a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="logo-carousel owl-carousel">
            <div class="logo-item">
                <div class="tablecell-inner">
                    <img src="front/img/products/tải xuống.png" loading="lazy" width="172" height="22" alt="BackMarket Logo" class="companies-list-area-logo">
                </div>
            </div>
            <div class="logo-item">
                <div class="tablecell-inner">
                    <img src="front/img/products/Logo_Nhã_Nam.jpg" loading="lazy" width="128" height="50" alt="Dolead logo" class="dolead-logo companies-list-area-logo">
                </div>
            </div>
            <div class="logo-item">
                <div class="tablecell-inner">
                    <img src="front/img/products/Dona.png" loading="lazy" width="133" height="30" alt="Trustfolio logo" class="trustfolio-logo companies-list-area-logo">
                </div>
            </div>
            <div class="logo-item">
                <div class="tablecell-inner">
                    <img src="front/img/products/logo_footer.png" loading="lazy" width="145" height="26" alt="Karos logo" class="karos-logo companies-list-area-logo">
                </div>
            </div>
            <div class="logo-item">
                <div class="tablecell-inner">
                    <img src="front/img/products/HNV.png" loading="lazy" width="145" height="26" alt="Karos logo" class="karos-logo companies-list-area-logo">
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="footer-left">
                    ...
                    <ul>
                        <li>Nhom 9 PMMNM</li>
                        <li>Mail: <a href="mailto:quangm202@gmail.com" style="color: #a1acb1;">thainhatx4@gmail.com</a></li>
                        <li>Phone: <a href="tel:0352276941" style="color: #a1acb1;">0123456789</a></li>
                    </ul>
