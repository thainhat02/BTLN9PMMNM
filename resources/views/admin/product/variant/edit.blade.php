        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <form method="post" action="admin/product/{{$product->id}}/variant/{{$product_detail->id}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            {{-- <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="color" id="color" placeholder="Color" type="text"
                                        class="form-control" value="{{$product_detail->color}}">
                                </div>
                            </div> --}}
                            ...
                            {{-- <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="size" id="size" placeholder="Size" type="text"
                                        class="form-control" value="{{$product_detail->size}}">
                                </div>
                            </div> --}}
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="qty" id="qty" placeholder="Số lượng" type="text"
                                        class="form-control" value="{{$product_detail->qty}}">
                                </div>
                            </div>
