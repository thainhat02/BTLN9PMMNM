                    ...
                    <div class="card-body">
                        <form method="post" action="admin/product" enctype="multipart/form-data">
                            ...
                            <div class="position-relative row form-group">
                                <label for="brand_id"
                                    class="col-md-3 text-md-right col-form-label">Nhà xuất bản</label>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="content" id="content"
                                        placeholder="Nội dung" type="text" class="form-control" value="">
                                </div>
                            </div>

                            <div class="position-relative row form-group">
                                <label for="price"
                                    class="col-md-3 text-md-right col-form-label">Giá bán</label>
                                <div class="col-md-9 col-xl-8">
                                    <input required name="price" id="price"
                                        placeholder="Giá" type="number" step="0.01" class="form-control" value="">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="discount" id="discount"
                                        placeholder="Giảm giá" type="number" step="0.01" class="form-control" value="">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="qty" id="qty"
                                           placeholder="Số lượng" type="text" class="form-control" value="">
                                </div>
                            </div>

                            <div class="position-relative row form-group">
                                <label for="tag"
                                    class="col-md-3 text-md-right col-form-label">Tác giả</label>
                                <div class="col-md-9 col-xl-8">
                                    <input required name="tag" id="tag"
                                        placeholder="Tác giả" type="text" class="form-control" value="">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                <label for="description"
                                    class="col-md-3 text-md-right col-form-label">Chi tiết</label>
                                <div class="col-md-9 col-xl-8">
                                    <textarea class="form-control" name="description" id="description" placeholder="Chi tiết" rows="3"></textarea>
                                </div>
                            </div>
