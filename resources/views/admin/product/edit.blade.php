                    ...
                    <div class="card-body">
                        <form method="post" action="admin/product/{{$product->id}}" enctype="multipart/form-data">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="price" id="price"
                                        placeholder="Giá bán" type="text" class="form-control" value="{{$product->price}}">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="tag" id="tag"
                                        placeholder="Tác giả" type="text" class="form-control" value="{{$product->tag}}">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <textarea class="form-control" name="description" id="description" placeholder="Chi tiết">{{$product->description}}</textarea>
                                </div>
                            </div>
