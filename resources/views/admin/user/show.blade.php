            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-body display_data">
                            ...
                            <div class="col-md-7 col-xl-6">
                                <p>
                                    <img style="height: 200px;" class="rounded-circle" data-toggle="tooltip"
                                        ...
                                        src="front/img/user/{{$user->avatar ?? 'default-avatar.jpg'}}" alt="Ảnh đại diện">
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group">
                            <label for="country"
                                class="col-md-5 text-md-right col-form-label">Quốc gia</label>
                            <div class="col-md-7 col-xl-6">
                                <p>{{$user->country ?? '-'}}</p>
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group">
                            <label for="phone" class="col-md-5 text-md-right col-form-label">Điện thoại</label>
                            <div class="col-md-7 col-xl-6">
                                <p>{{$user->phone ?? '-'}}</p>
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group">
                            <label for="level" class="col-md-5 text-md-right col-form-label">Quyền</label>
                            <div class="col-md-7 col-xl-6">
                        ...
                        <div class="position-relative row form-group">
                            <label for="description"
                                class="col-md-5 text-md-right col-form-label">Chi tiết</label>
                            <div class="col-md-7 col-xl-6">
